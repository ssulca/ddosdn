...
def topoloy():
    ...
    ids = [net.addDocker('ids1', ip='192.168.12.3/16', dimage=DI_SNORT,
                         mem_limit=MEM_IDS, dmcd='./start.sh'),
           net.addDocker('ids2', ip='192.168.13.3/16',
                         dimage=DI_SNORT, mem_limit=MEM_IDS,
                         dmcd='./start.sh'),
           net.addDocker('ids3', ip='192.168.14.3/16', dimage=DI_SNORT,
                         mem_limit=MEM_IDS, dmcd='./start.sh'),
           net.addDocker('ids4', ip='192.168.15.3/16',
                         dimage=DI_SNORT, mem_limit=MEM_IDS,
                         dmcd='./start.sh')]
    ...
    users = [net.addDocker('user_leg0', ip='192.168.4.10/16', dimage=DI_USER,
                           mem_limit=MEM_USER, dmcd=USER_CMD),
             net.addDocker('user_leg1', ip='192.168.4.11/16',
                           dimage=DI_USER, mem_limit=MEM_USER, dmcd=USER_CMD),
             net.addDocker('user_leg2', ip='192.168.5.12/16', dimage=DI_USER,
                           mem_limit=MEM_USER, dmcd=USER_CMD),

             net.addDocker('user_leg3', ip='192.168.5.13/16',
                           dimage=DI_USER, mem_limit=MEM_USER, dmcd=USER_CMD),
             net.addDocker('user_leg4', ip='192.168.6.14/16', dimage=DI_USER,
                           mem_limit=MEM_USER, dmcd=USER_CMD),
             net.addDocker('user_leg5', ip='192.168.6.15/16',
                           dimage=DI_USER, mem_limit=MEM_USER, dmcd=USER_CMD),
             net.addDocker('user_leg6', ip='192.168.7.16/16', dimage=DI_USER,
                           mem_limit=MEM_USER, dmcd=USER_CMD),
             net.addDocker('user_leg7', ip='192.168.7.17/16',
                           dimage=DI_USER, mem_limit=MEM_USER, dmcd=USER_CMD),
             net.addDocker('user_leg8',
                           ip='192.168.8.18/16', dimage=DI_USER,
                           mem_limit=MEM_USER, dmcd=USER_CMD),
             net.addDocker('user_leg9', ip='192.168.8.19/16',
                           dimage=DI_USER, mem_limit=MEM_USER, dmcd=USER_CMD),
             net.addDocker('user_leg10', ip='192.168.9.71/16', dimage=DI_USER,
                           mem_limit=MEM_USER, dmcd=USER_CMD),
             net.addDocker('user_leg11', ip='192.168.9.72/16',
                           dimage=DI_USER, mem_limit=MEM_USER, dmcd=USER_CMD)
             ]
    ...
    vict = [net.addDocker('vict0', ip='192.168.10.5/16', dimage=DI_SERVER,
                          mem_limit=MEM_SERVER,
                          dmcd='httpd-foreground'),
            net.addDocker('vict1', ip='192.168.11.50/16', dimage=DI_SERVER,
                          mem_limit=MEM_SERVER,
                          dmcd='httpd-foreground'),
            net.addDocker('vict2', ip='192.168.11.51/16', dimage=DI_SERVER,
                          mem_limit=MEM_SERVER,
                          dmcd='httpd-foreground')]
    ...
    bots = [net.addDocker('bot0', ip='192.168.4.20/16', dimage=DI_BOT,
                          mem_limit=MEM_BOT),
            net.addDocker('bot1', ip='192.168.5.21/16', dimage=DI_BOT,
                          mem_limit=MEM_BOT),
            net.addDocker('bot2', ip='192.168.6.22/16', dimage=DI_BOT,
                          mem_limit=MEM_BOT),
            net.addDocker('bot3', ip='192.168.7.23/16', dimage=DI_BOT,
                          mem_limit=MEM_BOT),
            net.addDocker('bot4', ip='192.168.8.24/16', dimage=DI_BOT,
                          mem_limit=MEM_BOT),
            net.addDocker('bot5', ip='192.168.9.25/16', dimage=DI_BOT,
                          mem_limit=MEM_BOT),
            net.addDocker('bot6', ip='192.168.5.26/16', dimage=DI_BOT,
                          mem_limit=MEM_BOT),
            net.addDocker('bot7', ip='192.168.8.27/16', dimage=DI_BOT,
                          mem_limit=MEM_BOT),
            ]
